    ...
    <section className="bg-gray-900 min-h-screen p-4 sm:p-6 lg:p-8">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="bg-gray-800 rounded-lg p-6 mb-6 shadow-lg border border-gray-700">
          ...
          <button
                  type="button"
                  onClick={() => navigate("/recommend_to_user")}
                  className="w-full sm:w-auto bg-gray-700 text-white font-medium rounded-lg text-sm px-5 py-2.5 text-center hover:bg-blue-700 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-gray-600 dark:hover:bg-gray-700 dark:focus:ring-blue-800"
                  >
                  Recommend a Book to your followers
                </button>
          </div>
